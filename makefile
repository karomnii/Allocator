...
# Znacznik czasowy: 2023-12-19 15:22:22.242960
#

OUTDIR		:= build-dir

CC          := gcc
CC_FLAGS    := -Wextra -fmax-errors=5 -Wno-parentheses -std=c11 -D_GNU_SOURCE -pedantic -DINSIDE_DANTE -fdiagnostics-color -Wall -Werror=vla -D_ANSI_OUTPUT -Wno-error=unused-parameter -Wno-error=implicit-fallthrough -Werror -xc -ggdb3 -Wno-error=parentheses 
